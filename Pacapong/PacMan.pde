public class PacMan {
  ...
  public void display() {
    ...
    if (direction.equals("RIGHT")) {
      arc(x, y, 18, 18, offset, TWO_PI - offset);
    } else if (direction.equals("LEFT")) {
      arc(x, y, 18, 18, 0, PI - offset);
      arc(x, y, 18, 18, PI + offset, TWO_PI);
    } else if (direction.equals("UP")) {
      arc(x, y, 18, 18, 0, 3*HALF_PI - offset);
      arc(x, y, 18, 18, 3*HALF_PI + offset, TWO_PI);
    } else if (direction.equals("DOWN")) {
      arc(x, y, 18, 18, 0, HALF_PI - offset);
      arc(x, y, 18, 18, HALF_PI + offset, TWO_PI);
    }
